...
class ActivityDetailInvoiceSubView extends GetView<ActivityDetailController> {
  const ActivityDetailInvoiceSubView({super.key});
                  ...
                  children: [
                    ...
                    Text(
                      NumberFormat.currency(
                        ...
                        symbol: 'Rp',
                        decimalDigits: 0,
                      ).format(controller.orderRideDetail.value.waitMoney),
                      style: controller.typographyServices.bodySmallBold.value
                          .copyWith(
                            color: controller
                                .themeColorServices
