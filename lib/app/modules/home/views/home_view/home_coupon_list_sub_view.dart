...
class HomeCouponListSubView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Visibility(
        visible: controller.availableCouponList.isNotEmpty,
        child: Column(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Container(
                        width: MediaQuery.of(context).size.width * 230 / 375,
                        child: AspectRatio(
                          aspectRatio: 230 / 95,
                          child: Placeholder(),
                        ),
                    ...
                    SizedBox(height: 10),
                    Text(
                      "Aktifkan Lokasi untuk Melihat Iklan",
                      style: controller.typographyServices.bodyLargeBold.value,
                      textAlign: TextAlign.center,
                    ),
                    SizedBox(height: 8),
                    Text(
                      "Izinkan akses lokasi agar kami dapat menampilkan iklan dan penawaran yang relevan di area kamu.",
                      style:
