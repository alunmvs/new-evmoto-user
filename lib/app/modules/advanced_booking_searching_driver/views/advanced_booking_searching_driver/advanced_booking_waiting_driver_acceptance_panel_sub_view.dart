...
class AdvancedBookingWaitingDriverAcceptancePanelSubView
    extends GetView<AdvancedBookingSearchingDriverController> {
  const AdvancedBookingWaitingDriverAcceptancePanelSubView({super.key});

  @override
  Widget build(BuildContext context) {
    return SlidingUpPanel(
      minHeight: 120 + (controller.isFetch.value ? 0 : 50),
      maxHeight: 120 + (controller.isFetch.value ? 0 : 50),
