class GoogleGeoCodeSearch {
  ...
  GoogleGeoCodeSearch.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.addressComponents != null) {
      data['address_components'] = this.addressComponents!
          .map((v) => v.toJson())
          .toList();
    }
    ...
    if (this.navigationPoints != null) {
      data['navigation_points'] = this.navigationPoints!
          .map((v) => v.toJson())
          .toList();
    }
...
class Location {
  ...
  Location({this.lat, this.lng, this.latitude, this.longitude});
