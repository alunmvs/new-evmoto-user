...
class DriverNotAvailableDialog extends StatelessWidget {
  final Function onTapOrderAgain;

  DriverNotAvailableDialog({super.key, required this.onTapOrderAgain});
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              DialogHelper.dismiss(DialogTags.driverNotAvailable);
                            },
                            child: Container(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: LoaderElevatedButton(
                              ...
                              onPressed: () async {
                                await onTapOrderAgain();
                              },
                              child: Text(
                                languageServices.language.value.orderAgain ??
                                    "-",
                                style: typographyServices.bodyLargeBold.value
                                    .copyWith(
