...
class DriverBusyDialog extends StatelessWidget {
  final Function onTapOrderAgain;

  DriverBusyDialog({super.key, required this.onTapOrderAgain});
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              DialogHelper.dismiss(DialogTags.driverBusy);
                            },
                            child: Container(
                      ...
                      ClipRRect(
                        borderRadius: BorderRadius.circular(16),
                        child: Image.asset(
                          "assets/images/img_driver_busy.png",
                        ),
                      ),
                      SizedBox(height: 16),
                      Text(
